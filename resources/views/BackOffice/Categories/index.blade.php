                ...
                <tbody>
                    @foreach ($cats as $slide)
                        <tr>
                            ...
                            <td>
                                @if($slide->active)
                                    <a href="/admin/categories/disable/{{ $slide->id }}" class="btn btn-sm btn-danger">Desactiver</a>
                                @else
                                    <a href="/admin/categories/enable/{{ $slide->id }}" class="btn btn-sm btn-success">Activer</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
